  ...
  return (
    <div className="flex items-center flex-col min-h-screen pb-7 px-2">
      ...
      >
        ...
        {nameInput !== "" && (
          <div className="flex items-center justfy-start flex-col mb-7 p-1 border-gray-100/25 border rounded-md">
      ...
      {links.map((link) => (
        ...
        >
          ...
          <div>
            <button className="border border-dashed p-1 rounded bg-slate-700 scale-110"
